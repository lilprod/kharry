...
<head>
	...
	<title>@lang('edit_package.page_header') | {{config('app.name', 'Kharry')}}</title>
	<!-- Favicon -->
	...
	<nav class="navbar navbar-default main-navigation" role="navigation">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbar">
              ...
              @guest
              <li><a href="{{ route('index') }}"><i class="lnr lnr-home"></i> @lang('edit_package.home_menu')</a></li>
              <li><a href="{{ route('tripannounces.create') }}"><i class="lnr lnr-car"></i> @lang('edit_package.tripannounce_menu')</a></li>
              <!--<li><a href="{{ route('receivepackage') }}"><i class="lnr lnr-book"></i> @lang('home.receivepackage_menu')</a></li>-->
              <li class="">
                      <a class="" href="{{ route('login') }}"><i class="lnr lnr-enter"></i>@lang('edit_package.login_menu')</a>
                  </li>
                  <li class="">
                      @if (Route::has('register'))
                          <a class="" href="{{ route('register') }}"><i class="lnr lnr-user"></i>@lang('edit_package.register_menu')</a>
                      @endif
                  </li>
                  ...
                  <li class="dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="true">@lang('edit_package.trips_menu')<span class="caret"></span>
                      </a>
                      <ul class="dropdown-menu">
                        <li><a href="{{ route('tripannounces.create') }}"> @lang('edit_package.tripannounce_menu')</a></li>
                        <li><a href="{{ route('tripannounces.index') }}"> @lang('edit_package.mytrips_menu')</a></li>
                        <li><a href="{{ route('index') }}"> @lang('edit_package.searchtrip_menu')</a></li>
                        
                      </ul>
                  </li>

                  <li class="dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="true">@lang('edit_package.mypackages_menu')<span class="caret"></span>
                      </a>
                      <ul class="dropdown-menu">
                        <li><a href="{{ route('pendingpackage') }}">@lang('edit_package.pendingpackage_menu')</a></li>
                        <li><a href="{{ route('packages.index') }}">@lang('edit_package.packagesent_menu')</a></li>
                        <li><a href="{{ route('packagedelivered') }}">@lang('edit_package.deliveredpackage_menu')</a></li>
                        <li><a href="{{ route('packagereceived') }}">@lang('edit_package.packagereceived_menu')</a></li>
                        <li><a href="{{ route('receivepackage') }}">@lang('edit_package.receivepackage_menu')</a></li>
                      </ul>
                  </li>

                  <li class="dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="true">@lang('edit_package.payments_menu')<span class="caret"></span>
                      </a>
                      <ul class="dropdown-menu">
                        <li><a href="{{ route('payments') }}">@lang('edit_package.myexpenses_menu')</a></li>
                        <li><a href="#">@lang('edit_package.myearnings_menu')</a></li>
                      </ul>
                  </li>

                  <li><a href="{{ route('forum.index') }}"> @lang('edit_package.forum_menu')</a></li>
                  ...
                  <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                        	<li><a href="{{ route('profils.index') }}"> @lang('edit_package.myaccount_menu')</a></li>
                            <li><a class="" href="{{ route('logout') }}"
                            onclick="event.preventDefault();
                                            document.getElementById('logout-form').submit();">
                                @lang('edit_package.logout_menu')
                            </a>
		...
		<div class="container">
			<div class="row">
				...
				<div class="page-ads box">
					<h2 class="title-2">@lang('edit_package.page_header')</h2>
					@include('inc.messages')
					<form role="form" class="login-form"  method="POST" action="{{ route('packages.update',$package->id) }}" enctype="multipart/form-data">
							{{ csrf_field() }}
              {{ method_field('PATCH') }}
							
							<div class="form-group">	
								<label class="control-label">@lang('edit_package.package_weight')</label>
							...
							<div class="form-group">
								<label class="control-label" for="textarea">@lang('edit_package.package_content')</label>
							...
							<div class="form-group">
								...
								<label class="control-label">@lang('edit_package.sender_email')</label>
							...
							<div class="form-group">
								...
								<label class="control-label">@lang('edit_package.receiver_name')</label>
								<input class="form-control input-md" name="recipient_name" placeholder="@lang('edit_package.receiver_name')" type="text" value="{{$package->recipient_name}}" required>
								
							</div>
							
							<div class="form-group">
								
								<label class="control-label">@lang('edit_package.receiver_phonenumber')</label>
								<input class="form-control input-md" name="recipient_phone_number" placeholder="@lang('edit_package.receiver_phonenumber')" type="text" value="{{$package->recipient_phone_number}}" required>
								
							</div>
							
							
							<div class="form-group ">
									<label class="control-label">@lang('edit_package.receiver_email')</label>
							...
							<button class="btn btn-common" type="submit">@lang('edit_package.submit_button')</button>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 wow fadeIn" data-wow-delay="0s">
              <div class="widget">
                <h3 class="block-title">@lang('edit_package.about_menu')</h3>
                <div class="textwidget">
                  <p>@lang('edit_package.text')</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12 wow fadeIn" data-wow-delay="0.5s">
              <div class="widget">
                <h3 class="block-title">@lang('edit_package.block_title')</h3>
                <ul class="menu">
                  <li><a href="{{ route('index')}}">@lang('edit_package.home_menu')</a></li>
                  <li><a href="{{route('faq')}}">FAQ</a></li>
                  <li><a href="{{ route('about')}}">@lang('edit_package.about_menu')</a></li>
                  <li><a href="{{ route('contact')}}">@lang('edit_package.contact_menu')</a></li>
