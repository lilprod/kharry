...
<head>
    ...
    <title>@lang('email.page_title') | {{config('app.name', 'Kharry')}}</title>
    ...
    <nav class="navbar navbar-default main-navigation" role="navigation">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
              ...
              @guest
              <li><a href="{{ route('index') }}"><i class="lnr lnr-home"></i> @lang('email.home_menu')</a></li>
              <li><a href="{{ route('tripannounces.create') }}"><i class="lnr lnr-car"></i> @lang('email.tripannounce_menu')</a></li>
              <li><a href="{{ route('receivepackage') }}"><i class="lnr lnr-book"></i> @lang('email.receivepackage_menu')</a></li>
              <li><a href="{{ route('forum.index') }}"><i class="lnr lnr-users"></i>@lang('email.forum_menu')</a></li>
              <li class="">
                      <a class="" href="{{ route('login') }}"><i class="lnr lnr-enter"></i>@lang('email.login_menu')</a>
                  </li>
                  <li class="">
                      @if (Route::has('register'))
                          <a class="" href="{{ route('register') }}"><i class="lnr lnr-user"></i>@lang('email.register_menu')</a>
                      @endif
                  </li>
              ...
              @else
                  ...
                  <li class="dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="true">@lang('email.trips_menu')<span class="caret"></span>
                      </a>
                      <ul class="dropdown-menu">
                        <li><a href="{{ route('tripannounces.create') }}"> @lang('email.tripannounce_menu')</a></li>
                        <li><a href="{{ route('tripannounces.index') }}"> @lang('email.mytrips_menu')</a></li>
                        <li><a href="{{ route('index') }}"> @lang('email.searchtrip_menu')</a></li>
                  ...
                  <li class="dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="true">@lang('email.mypackages_menu')<span class="caret"></span>
                      </a>
                      <ul class="dropdown-menu">
                        <li><a href="{{ route('pendingpackage') }}">@lang('email.pendingpackage_menu')</a></li>
                        <li><a href="{{ route('packages.index') }}">@lang('email.packagesent_menu')</a></li>
                        <li><a href="{{ route('packagedelivered') }}">@lang('email.deliveredpackage_menu')</a></li>
                        <li><a href="{{ route('packagereceived') }}">@lang('email.packagereceived_menu')</a></li>
                        <li><a href="{{ route('receivepackage') }}">@lang('email.receivepackage_menu')</a></li>
                      </ul>
                  </li>

                  <li class="dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="true">@lang('email.payments_menu')<span class="caret"></span>
                      </a>
                      <ul class="dropdown-menu">
                        <li><a href="{{ route('payments') }}">@lang('email.myexpenses_menu')</a></li>
                        <li><a href="#">@lang('email.myearnings_menu')</a></li>
                      </ul>
                  </li>

                  <li><a href="{{ route('forum.index') }}"> @lang('email.forum_menu')</a></li>
                  ...
                  <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{ route('profils.index') }}"> @lang('email.myaccount_menu')</a></li>
                            <li><a class="" href="{{ route('logout') }}"
                            onclick="event.preventDefault();
                                            document.getElementById('logout-form').submit();">
                                @lang('email.logout_menu')
                            </a>
                    ...
                    <form role="form" class="login-form" method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="form-group">
                            <div class="input-icon">
                                ...
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="@lang('email.email')" required>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 wow fadeIn" data-wow-delay="0s">
              <div class="widget">
                <h3 class="block-title">@lang('email.about_menu')</h3>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 wow fadeIn" data-wow-delay="0.5s">
              <div class="widget">
                <h3 class="block-title">@lang('email.block_title')</h3>
                <ul class="menu">
                  <li><a href="{{ route('index')}}">@lang('email.home_menu')</a></li>
                  <li><a href="{{route('faq')}}">FAQ</a></li>
                  <li><a href="{{ route('about')}}">@lang('email.about_menu')</a></li>
                  <li><a href="{{ route('contact')}}">@lang('email.contact_menu')</a></li>
                  <li><a href="{{ URL::to('locale/en') }}"><img src="{{asset('/assets/assets/img/us.png') }}" alt="" style="width: 15px;height:10px;"> English</a></li>
