...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasfile('profil_image')) {
            ...
            // Upload Image
            $path = $request->file('profil_image')->storeAs('public/cover_images', $fileNameToStore);
        } else {
        ...
        $user->profil_image = $fileNameToStore;
        $user->phone_number = $request->input('phone_number');
        $user->user_address = $request->input('user_address');
        $user->user_profession = $request->input('user_profession');
